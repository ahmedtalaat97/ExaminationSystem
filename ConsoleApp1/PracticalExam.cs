...
namespace ConsoleApp1
{
    public class PracticalExam : Exam
    {
        ...
        public PracticalExam(TimeSpan timeOfExam, int numberOfQuestions, Subject associatedSubject , List<Question>  questions) : base(timeOfExam, numberOfQuestions, associatedSubject)
        {
            Questions = questions;
        }
        ...
        public override void ShowExam()
        {
            ...
            Console.WriteLine($"Practical Exam for {AssociatedSubject.SubjectName}");
